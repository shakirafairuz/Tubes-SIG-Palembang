<?php
$conn = mysqli_connect("sql106.epizy.com", "epiz_34191876", "cocoLmZsReb0iY", "epiz_34191876_data_sekolah");
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="epiz_34191876_data_sekolah.php" class="dropdown-item">Data Sekolah</a>
                    </div>
                </div>
            </div>
